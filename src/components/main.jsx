...
<p className="font-medium text-gray-700 dark:text-gray-400">តេីអ្នកទាំងអស់គ្នាមានអារម្មណ៏រៀនទេសាលារៀនខ្ញុំការឧបត្ថម្ភសាច់ប្រាក់ក្នុងខែ150$ហើយមានកន្លែងស្នាក់free​​</p>
</a>
...
<div className="max-w-sm mx-7 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <p className="mb-3 font-medium text-gray-700 dark:text-gray-400 ">មានបង្រៀនhackerនិង​បង្កើតកម្មវិធីផ្សេងៗបើមានចំណប់អារម្មណ៏អាចទាក់ទាងមកតាមTelegram</p>
...
<div className="w-full max-w-sm mx-7 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="flex flex-col items-center pb-10 ">
        <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://i.ibb.co/XtK8s7p/IMG-20240807-184734-947.jpg" alt="Bonnie image"/>
